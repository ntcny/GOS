...
$"P\fskobk{\overrightarrow{\texttailn} = \overrightarrow{y} / \overrightarrow{\xi} = \overrightarrow{x}} = p(\overrightarrow{y} / \overrightarrow{x})".$
\end{defs}
...
\begin{proofs}
  ...
  $"P\fskobk{\overrightarrow{\texttailn} = \overrightarrow{y}} = \summa{}{\overrightarrow{x} \in X^n} p(\overrightarrow{y} / \overrightarrow{x})*P{\overrightarrow{\xi} = \overrightarrow{x}}." $
\end{proofs}
...
$P"\fskobk{\overrightarrow{\texttailn} = \overrightarrow{y} / \overrightarrow{\xi} = \overrightarrow{x}} = P{\texttailn_1 = y_{n_1}/ \xi_1 = x_{n_1}}*..*P{\texttailn_n = y_{n_n}/ \xi_n = x_{n_n}}"$
...
ДКСПБ - стационарный (ДСКСБП), если P_1 = .. = P_n = ..
\end{defs}
>>>>>>> 94672ee40603dbc655d31764af6e6743dd1637e1
